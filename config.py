...
SITE_CONFIG = {
    ...
    'skills': {
        'Android': ['Kotlin', 'Java', 'Jetpack Compose', 'View System', 'RecyclerView', 'Coroutines', 'Flow', 'Room', 'WorkManager', 'Navigation', 'Lifecycle'],
        'Architecture': ['MVVM', 'Redux (State Management)', 'MVI', 'Clean Architecture', 'Repository Pattern', 'DI (Hilt/Koin)', 'OOP'],
        'Performance & Optimization': ['Memory Management', 'Heap Analysis', 'LeakCanary', 'Profiler', 'ANR Prevention'],
        'SDK Integration': ['Modiface', 'Sendbird', 'Firebase', 'Analytics SDK', 'Wowza', 'Google Maps', 'Location Services'],
        'Testing & CI/CD': ['TDD', 'JUnit5', 'MockK', 'Integration Testing', 'Bitrise', 'GitHub Actions', 'Crashlytics'],
        'E-commerce': ['Inventory Management', 'Cart Management', 'Payment Integration', 'Product Catalog', 'Stock Handling'],
